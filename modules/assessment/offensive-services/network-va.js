import { calculateNetworkPtMDFromIp } from "./network-pt.js?v=1.4";
import { createWizardDraft, generateId, getInitialIncludeRetest, renderChoiceStep } from "../core.js?v=1.4";
  ...
  getLogicHtml() {
    return `
      <div class="logic-flow">
        ...
        <div class="logic-node">assessment = min(9, ceil(ipCount / 8.8))</div>
        <div class="logic-node">reporting = ceil(assessment * 0.25)</div>
        <div class="logic-node">retest = min(4, ceil(assessment / 2))</div>
