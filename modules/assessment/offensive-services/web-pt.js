    ...
    return `
      <div class="logic-flow">
        ...
        <div class="logic-branch">
          ...
          <div class="logic-arrow">↓ yes</div>
          <div class="logic-node">assessment = urlCount; reporting = ceil(assessment * 0.3); retest = ceil((assessment + reporting) * 0.25)</div>
          ...
          <div class="logic-arrow">↓ no</div>
          <div class="logic-node">assessment = 1; reporting = 1; retest = 1</div>
        </div>
        <div class="logic-arrow">↓ no (greybox/whitebox)</div>
        <div class="logic-node">Greybox: small=(2,1,1), medium=(5,1,1), large=(9,1,2)</div>
        <div class="logic-node">Whitebox: assessment = ceil(greybox.assessment * 1.2), reporting/retest same as greybox</div>
