  ...
  getLogicHtml() {
    return `
      <div class="logic-flow">
        ...
        <div class="logic-node">Onsite = (5 initial + 1 reporting), Remote = (4 initial + 1 reporting)</div>
        ...
        <div class="logic-node">Fully managed onboarding? yes = +1 initial</div>
        <div class="logic-node">Bespoke content? yes = +2 initial and +1 reporting</div>
        ...
        <div class="logic-node outcome">Total MD = initial + reporting (retest fixed to 0)</div>
      </div>
    `;
  },
};
