...
const CSR_TYPE_OPTIONS = [
  {
    ...
    points: ["7 days total", "Assessment 6 MD", "Reporting 1 MD"],
  },
  {
    value: CSR_TYPE,
    title: "CSR",
    ...
    points: ["14 days total", "Assessment 12 MD", "Reporting 2 MD"],
  },
  {
    value: CSR_PLUS_TYPE,
    title: "CSR Plus",
    ...
    points: ["20 days total", "Assessment 17 MD", "Reporting 3 MD"],
  },
];
  ...
  getLogicHtml() {
    return `
      <div class="logic-flow">
        ...
        <div class="logic-node outcome">total = assessment + reporting + framework mapping + follow-up</div>
      </div>
    `;
  },
};
