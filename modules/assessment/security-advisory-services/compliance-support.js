  ...
  getLogicHtml() {
    return `
      <div class="logic-flow">
        ...
        <div class="logic-node">Policies Templates = 1 initial / 0 reporting / 0 retest</div>
        ...
        <div class="logic-node">Remediation Support = 10, 20, 30, or custom initial days</div>
        <div class="logic-node">Certification Support = 6 initial / 0 reporting / 0 retest</div>
