import { mobilePtService } from "./offensive-services/mobile-pt.js?v=0.4.1";
import { networkPtService } from "./offensive-services/network-pt.js?v=0.4.1";
import { networkVaService } from "./offensive-services/network-va.js?v=0.4.1";
import { webPtService } from "./offensive-services/web-pt.js?v=0.4.1";
import { complianceSupportService } from "./security-advisory-services/compliance-support.js?v=0.4.1";
import { crewReviewService } from "./security-advisory-services/crew-review.js?v=0.4.1";
import { cyberSecurityReviewService } from "./security-advisory-services/cyber-security-review.js?v=0.4.1";
import { incidentResponseTtxService } from "./security-advisory-services/incident-response-ttx.js?v=0.4.1";
import { trainingAwarenessService } from "./security-advisory-services/training-awareness.js?v=0.4.1";
    ...
    <div class="mb-3">
      ...
      ${!locked && draft.complexity === "large" ? `
        <div class="complexity-note mt-3">
          The testing effort would be performed on a time-boxed basis, where testing is prioritised on functions within the application that are more likely to contain vulnerabilities, based on experience gained from testing similar applications. As a point of reference, a form with up to eight input fields typically requires two to three working hours to test. Time-boxed testing is useful as a baseline assessment and is not intended to be exhaustive.
        </div>
      ` : ""}
...
export function renderReviewStep({ draft, review, fullRetestMd, reviewConfig = {} }) {
  ...
  const mdBreakdownItems = [
    { label: "Assessment", value: review.md.initial },
