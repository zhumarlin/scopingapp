import { mobilePtService } from "./offensive-services/mobile-pt.js";
import { networkPtService } from "./offensive-services/network-pt.js";
import { networkVaService } from "./offensive-services/network-va.js";
import { webPtService } from "./offensive-services/web-pt.js";
import { crewReviewService } from "./security-advisory-services/crew-review.js";
import { cyberSecurityReviewService } from "./security-advisory-services/cyber-security-review.js";
...
export function renderReviewStep({ draft, review, fullRetestMd, reviewConfig = {} }) {
  ...
  const retestHelper = reviewConfig.retestHelper || "Would you like to include retest (follow-up testing) after remediation to verify that identified issues have been fixed?";
      ...
      ${summaryVisible ? `
        <section class="review-card mb-3">
          <div class="review-card__hero">
            ...
            <div class="review-card__total">
              <span class="review-card__total-label">Estimated Total</span>
              <strong class="review-card__total-value">${review.md.total} MD</strong>
            </div>
          </div>
...
export const SERVICE_GROUPS = [
  {
    ...
    description: "Existing assessment calculators available for active use.",
  },
  {
    id: "security-advisory-services",
    title: "Security Advisory Services",
    description: "Advisory and maturity review services aligned to control frameworks.",
  },
];
