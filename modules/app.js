import { getLogicServices, resolveAssessmentGroupId, startAssessmentWizard } from "./assessment/core.js";
...
function buildCopyableTable(sourceTable) {
  ...
  appendCopiedTotalRow(clonedTable);
...
function appendCopiedTotalRow(tableEl) {
...
function getTypeDisplay(item) {
  ...
  if (item?.serviceId === "crew_review" || item?.type === "crew_review") {
